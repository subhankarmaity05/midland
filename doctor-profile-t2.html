...
<html class="no-js" lang="en">
  ...
  <!-- Mirrored from html.laralink.com/nischinto/nischinto/doctor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Sep 2024 08:24:22 GMT -->
  <head>
    <!-- Meta Tags -->
    <meta charset="utf-8">
              ...
              <div class="st-doctors-info-left">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="assets/img/member1.webp" alt class="st-zoom-in">
                    <div class="st-member-social-wrap">
                      <img src="assets/img/shape/member-shape.svg" alt="shape"
                ...
                <ul class="st-doctors-special st-mp0">
                  <li><b>Speciality :</b><span>Respiratory & Critical
                      Care</span></li>
                  <li><b>Experience :</b><span>22 Years+</span></li>
                  <li><b>Languages :</b><span>English, Spanish</span></li>
                  <li><b>Types Of :</b><a
                      href="department_details.html">Department of Respiratory &
                      Critical Care</a></li>
                </ul>
                ...
                <div class="st-shedule-wrap st-style1">
                  <div class="st-shedule">
                    ...
                    <ul class="st-footer-contact-list st-mp0">
                      <li><span
                          class="st-footer-contact-title">Address:</span>
                        Mandir Marg, Mahanagar, Lucknow
                      </li>
                      <li><span
                          class="st-footer-contact-title">Email:</span>
                        info.midlandhealthcare@gmail.com</li>
                      <li><span
                          class="st-footer-contact-title">Phone:</span> <a
                          href="tel:0522-4655555"> 0522-4655555</a></li>
                      <li><span class="st-footer-contact-title"></span><a
                          href="tel:8004024365">8004024365</a></li>
                      <li><span class="st-footer-contact-title"></span><a
                          href="tel:0522-4042888">0522-4042888 </a></li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="col-xl-7 col-lg-9">
              ...
              <div class="st-doctors-info-right">
                <div class="st-doctor-heading">
                  <h3 class="st-doctor-name">Dr. Apoorva Singh</h3>
                  <div class="st-doctor-designation">Department of Respiratory &
                    Critical Care</div>
                  <div class="st-doctor-desc">MBBS, MD (Respiratory)</div>
                </div>
                <div class="st-height-b20 st-height-lg-b20"></div>

                <!-- Button trigger modal -->
                <button type="button" class="st-btn st-style1 st-size-medium st-color1"
                  ...
                  <div class="tab-content">
                    <div id="Biography" class="st-tab active">
                      <div class="st-doctor-details-box">
                        <p>Dr. Apoorva Singh specializes in Respiratory,
                          Critical Care and Sleep Medicine. Within these fields,
                          she possesses extensive knowledge and experience in
                          diagnosing and treating various respiratory conditions
                          such as asthma, chronic obstructive pulmonary disease
                          (COPD) & pneumonia. Additionally, she is adept at
                          managing critical illnesses in the intensive care unit
                          (ICU), including sepsis, respiratory failure, and
                          acute respiratory distress syndrome (ARDS).
                        </p>

                        <p>Dr. Apoorva Singh has expertise in evaluating and
                          managing sleep disorders such as obstructive sleep
                          apnea, insomnia, narcolepsy, and restless legs
                          syndrome. She employs a multidisciplinary approach to
                          address these conditions, integrating cutting-edge
                          diagnostics and therapeutic modalities to optimize
                          patient outcomes and improve their quality of
                          life.</p>
                      </div>
                    </div>
                    <div id="Education" class="st-tab">
                      <div class="st-doctor-details-box">
                        <ul>
                          <li>PHD degree in Neorology at University of Mediserv
                            (2006)</li>
                          <li>Master of Neoro Surgery at University of Mediserv
                            (2002)</li>
                          <li>MBBS degree in Neurosciences at University of
                            Mediserv (2002)</li>
                          <li>Higher Secondary Certificate at Mediserv collage
                            (1991)</li>
                        </ul>
                      </div>
                    </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5"
              id="exampleModalLabel">Make an appointment</h1>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    <label>Booking Date</label>
                    <input name="udate" type="text" id="udate"
                      placeholder="dd/mm/yy" class="hasDatepicker">
                    <div class="form-field-icon"><i
                        class="fa fa-calendar"></i></div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    ...
                    <div class="st-custom-select-wrap">
                      ...
                      <!-- <select name="udepartment" id="udepartment"
                        class="st_select1 select2-hidden-accessible"
                        data-placeholder="Select department"
                        data-select2-id="udepartment" tabindex="-1"
                        aria-hidden="true">
                        ...
                        style="width: 453px;"><span class="selection"><span
                            class="select2-selection select2-selection--single"
                            role="combobox" aria-haspopup="true"
                            aria-expanded="false" tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-udepartment-container"><span
                              class="select2-selection__rendered"
                              id="select2-udepartment-container" role="textbox"
                ...
                <div class="col-lg-6">
                  <div class="st-form-field st-style1">
                    ...
                    <div class="st-custom-select-wrap">
                      ...
                      <!-- <select name="udoctor"
                        class="st_select1 select2-hidden-accessible"
                        id="udoctor" data-placeholder="Select doctor"
                        data-select2-id="udoctor" tabindex="-1"
                        aria-hidden="true">
                        ...
                        style="width: 453px;"><span class="selection"><span
                            ...
                            aria-expanded="false" tabindex="0"
                            aria-disabled="false"
                            aria-labelledby="select2-udoctor-container"><span
                              class="select2-selection__rendered"
                              id="select2-udoctor-container" role="textbox"
                              aria-readonly="true"><span
                                class="select2-selection__placeholder">Select
                                doctor</span></span><span
                              class="select2-selection__arrow"
                              role="presentation"><b
                                role="presentation"></b></span></span></span><span
                          class="dropdown-wrapper"
